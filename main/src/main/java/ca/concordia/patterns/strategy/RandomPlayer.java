...
public class RandomPlayer implements Order {
    ...
    public RandomPlayer(Player p_Initiator, Territory p_Source, Territory p_Target, int p_Num) {
    ...
    public RandomPlayer(Player p_Initiator, Territory p_TargetTerritory) {
        this.d_Target = p_TargetTerritory;
        this.d_Initiator = p_Initiator;
    }

    public RandomPlayer(Player p_Initiator, Territory p_Target_territory, int p_To_deploy) {
        this.d_Target = p_Target_territory;
        this.d_Initiator = p_Initiator;
        this.d_Num = p_To_deploy;
    }

    public RandomPlayer(Player p_Initiator, Player p_Negotiate_PlayerId) {
        this.d_Initiator = p_Initiator;
