...
public class CheaterPlayer implements OrderInterface {
    ...
    public CheaterPlayer(Player p_Initiator, Territory p_Source, Territory p_Target, int p_Num) {
    ...
    public CheaterPlayer(Player p_Initiator, Territory p_TargetTerritory) {
        this.d_Target = p_TargetTerritory;
        this.d_Initiator = p_Initiator;
    }

    public CheaterPlayer(Player p_Initiator, Territory p_Target_territory, int p_To_deploy) {
