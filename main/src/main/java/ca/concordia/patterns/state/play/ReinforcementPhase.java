...
public class ReinforcementPhase extends MainPlay {
    ...
    public void reinforce() {
        LogUtil.log("reinforcing ");
        LogUtil.log("size" + d_ge.getListOfPlayers().size());
    ...
    private int assignReinforcementPhase(Player p_Player) {
        ...
        LogUtil.log("#countries own by player: " + p_Player.getPlayerName() + " is " + l_CountryOwnedByPlayer);
        ...
        LogUtil.log("#net continent value of all the continents controlled by player: " + l_NetContinentValue);
     ...
     */
    public void next() {
        LogUtil.log("setting order creation phase ");
